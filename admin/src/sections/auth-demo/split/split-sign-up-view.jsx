  ...
  const renderForm = (
    <Stack spacing={3}>
      ...
      <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2}>
        <Field.Text name="company.nameEn" label="Comapny name (English)" InputLabelProps={{ shrink: true }} />
        <Field.Text name="company.nameAr" label="Company name (Arabic)" InputLabelProps={{ shrink: true }} />
      </Stack>
